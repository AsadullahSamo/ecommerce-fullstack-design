            ...
            {cartItems.length === 0 ? (
              ...
              cartItems.map(item => (
                <div key={item.id} className="p-4 flex items-start gap-4">
                  <div className="w-[80px] h-[80px] shrink-0 border border-[#DEE2E7] rounded flex items-center justify-center bg-white overflow-hidden">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-[#8B96A5] mb-3">Seller: {item.seller}</p>
